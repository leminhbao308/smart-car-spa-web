...
const AdminHeader = () => {
  ...
  const generateBreadcrumbItems = () => {
    ...
    const pathMap: { [key: string]: string } = {
      ...
      "service-packages-overview": "Tổng quan gói dịch vụ",
      "service-package-types": "Loại gói dịch vụ",
      "service-packages-list": "Gói dịch vụ",
  ...
  const getPageTitle = () => {
    ...
    const titleMap: { [key: string]: string } = {
      ...
      permissions: "Phân quyền",
      "service-packages-overview": "Tổng quan gói dịch vụ",
      "service-package-types": "Quản lý loại gói dịch vụ",
      "service-packages-list": "Quản lý gói dịch vụ",
      "service-categories": "Danh mục dịch vụ",
      "car-profiles": "Hồ sơ xe",
      "care-processes": "Quy trình chăm sóc",
