...
const EditVehicleProfileModalInner: React.FC<EditVehicleProfileModalProps> = ({
  ownerId,
  visible,
  onCancel,
  onSuccess,
          ...
          >
            ...
            >
              <div style={{ marginBottom: 12 }}>
                <strong style={{ color: "#b45309" }}>✏️ Chỉnh sửa:</strong> Cập
                nhật thông tin cần thiết cho hồ sơ xe
              </div>
              <div style={{ marginBottom: 12 }}>
                <strong style={{ color: "#b45309" }}>📋 Biển số xe:</strong> Đảm
                bảo biển số đúng định dạng (VD: 51A-12345)
              </div>
              <div style={{ marginBottom: 12 }}>
                <strong style={{ color: "#b45309" }}>📊 Số km:</strong> Cập nhật
                số km hiện tại chính xác
              </div>
              <div style={{ marginBottom: 12 }}>
                <strong style={{ color: "#b45309" }}>🏭 Thông tin xe:</strong>{" "}
                Chọn đúng hãng, loại và dòng xe
              </div>
              <div>
                <strong style={{ color: "#b45309" }}>👤 Chủ xe:</strong> Xác
                nhận thông tin chủ xe chính xác
              </div>
            </div>
          </Card>
        )}
