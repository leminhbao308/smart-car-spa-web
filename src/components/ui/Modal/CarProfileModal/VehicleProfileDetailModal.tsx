...
interface VehicleProfileDetailModalProps {
  ...
  onEditSuccess?: (updatedProfile: VehicleProfileDisplay) => void;
...
const VehicleProfileDetailModal: React.FC<VehicleProfileDetailModalProps> = ({
  ...
  const [localProfile, setLocalProfile] = React.useState<VehicleProfileDisplay | null>(profile);
  ...
  // Handle edit success - update local state and trigger refresh
  const handleEditSuccess = async (updatedProfile: VehicleProfileDisplay) => {
          ...
          >
            <Row gutter={[20, 16]}>
              <Col xs={24} sm={12}>
                ...
                <Tag
                  color={getStatusColor(localProfile.is_active, localProfile.is_deleted)}
                  style={{fontSize: 13, padding: '4px 12px'}}
                >
                  {getStatusText(localProfile.is_active, localProfile.is_deleted)}
                </Tag>
              </Col>
              <Col xs={24} sm={12}>
                <div style={{display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8}}>
                ...
                <Text style={{fontSize: 16, fontWeight: 600, color: '#1f2937'}}>
                  {localProfile.distance_traveled.toLocaleString()} km
                </Text>
              </Col>
            </Row>
          </Card>
            ...
            <Row gutter={[20, 16]}>
              ...
              <Col xs={24} sm={12}>
                <div style={{marginBottom: 12}}>
                  ...
                  <div style={{display: 'flex', alignItems: 'center', gap: 8}}>
                    {localProfile.brand_logo && (
                      <Avatar
                        src={localProfile.brand_logo}
                        size="small"
                        style={{flexShrink: 0}}
                      />
                    )}
                    <Text style={{fontSize: 15, fontWeight: 500}}>
                      {localProfile.brand_name || 'Chưa cập nhật'}
                    </Text>
                  </div>
                </div>
              </Col>
              <Col xs={24} sm={12}>
                <div style={{marginBottom: 12}}>
                  ...
                  <Tag
                    ...
                    style={{fontSize: 13, padding: '4px 12px'}}
                  >
                    {localProfile.type_name || 'Chưa cập nhật'}
                  </Tag>
                </div>
              </Col>
              <Col xs={24} sm={12}>
                <div style={{marginBottom: 12}}>
                  ...
                  <Text style={{fontSize: 15, fontWeight: 500}}>
                    {localProfile.model_name || 'Chưa cập nhật'}
                  </Text>
                </div>
              </Col>
            </Row>
              ...
              <Col xs={24} sm={12}>
                <div style={{marginBottom: 12}}>
                  ...
                  <div style={{display: 'flex', alignItems: 'center', gap: 8}}>
                    ...
                    />
                    <Text style={{fontSize: 15, fontWeight: 500}}>
                      {localProfile.owner_name || 'Chưa cập nhật'}
                    </Text>
                  </div>
                </div>
              </Col>
                ...
                <div style={{marginBottom: 12}}>
                  ...
                  <div style={{display: 'flex', alignItems: 'center', gap: 8}}>
                    ...
                    <Text style={{fontSize: 15}}>
                      {localProfile.owner_phone || 'Chưa cập nhật'}
                    </Text>
                  </div>
                </div>
              </Col>
              <Col xs={24}>
                <div style={{marginBottom: 12}}>
                  ...
                  <div style={{display: 'flex', alignItems: 'center', gap: 8}}>
                    ...
                    <Text style={{fontSize: 15}}>
                      {localProfile.owner_email || 'Chưa cập nhật'}
                    </Text>
                  </div>
                </div>
              </Col>
              ...
              <Col xs={24} sm={12}>
                <div style={{marginBottom: 12}}>
                  ...
                  <Text style={{fontSize: 14}}>
                    {formatDate(localProfile.created_date)}
                  </Text>
                </div>
              </Col>
              <Col xs={24} sm={12}>
                <div style={{marginBottom: 12}}>
                  ...
                  <Text style={{fontSize: 14}}>
                    {formatDate(localProfile.modified_date)}
                  </Text>
                </div>
              </Col>
              <Col xs={24} sm={12}>
                <div style={{marginBottom: 12}}>
                  ...
                  <Text style={{fontSize: 14}}>
                    {localProfile.created_by || 'Hệ thống'}
                  </Text>
                </div>
              </Col>
              <Col xs={24} sm={12}>
                <div style={{marginBottom: 12}}>
                  ...
                  <Text style={{fontSize: 14}}>
                    {localProfile.modified_by || 'Hệ thống'}
                  </Text>
                </div>
              </Col>
            </Row>
